...
<template>
  <main v-if="loading" class="loading-screen">
    <img class="brand-mark" src="/halfcloud-mark.svg" alt="Halfcloud">
  ...
  <main v-else-if="!authenticated" class="auth-shell">
    ...
    <section class="auth-panel">
      <div class="brand"><img class="brand-mark" src="/halfcloud-mark.svg" alt=""><strong>HalfCloud</strong></div>
  ...
  <main v-else class="app-shell">
    <header class="topbar">
      <div class="brand"><img class="brand-mark" src="/halfcloud-mark.svg" alt=""><strong>HalfCloud</strong><span class="version">0.1</span></div>
