...
export const providerMetadata: ProviderMetadata[] = [
  ...
  { id: 'openai', label: 'OpenAI', icon: '/providers/openai.png', requiresEndpoint: false, recommendedModel: 'gpt-5.6-luna' },
  { id: 'anthropic', label: 'Anthropic', icon: '/providers/anthropic.svg', requiresEndpoint: false, recommendedModel: 'claude-sonnet-4-5' },
  { id: 'azure-foundry', label: 'Azure Foundry', icon: '/providers/azure-foundry.png', requiresEndpoint: true, recommendedModel: 'gpt-5.6-luna' },
...
const fallbackModels: Record<LlmProvider, string[]> = {
  openai: [], anthropic: [], 'azure-foundry': [], cerebras: [], grok: [], gemini: [], groq: [],
};
